...
export default function Register() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", fontFamily: "'Inter', system-ui, sans-serif", background: "#0a0a0f" }}>
      ...
      {/* ── LEFT PANEL (Matching Login design) ───────────────────────── */}
      <div
        ref={leftRef}
        style={{
          flex: 1,
        ...
        <div style={{ position: "relative", zIndex: 10 }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontSize: 15, color: "rgba(255,255,255,0.45)", marginTop: 8 }}>
              Set up your organization on AI ATS in seconds
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <div>
              ...
              <div style={{
                position: "relative",
                background: focused === "orgName" ? "rgba(255,107,53,0.06)" : "rgba(255,255,255,0.04)",
                border: `1.5px solid ${focused === "orgName" ? "rgba(255,107,53,0.5)" : "rgba(255,255,255,0.1)"}`,
                borderRadius: 12,
                transition: "all 0.2s ease",
              }}>
                <Building2 size={16} color="rgba(255,255,255,0.3)" style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)" }} />
                <input
                  type="text"
                  value={orgName}
